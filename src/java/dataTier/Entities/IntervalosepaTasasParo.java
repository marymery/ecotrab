...
/**
 * IntervalosepaTasasParo generated by hbm2java
 */
public class IntervalosepaTasasParo  implements java.io.Serializable {
    ...
    public IntervalosepaTasasParo(int year, int sexo, int estudGr, int edadGr, int minT, int p20T, int p40T, int p60T, int p80T, int maxT) {
       this.year = year;
       this.sexo = sexo;
