...
/**
 * EpaTasasParo generated by hbm2java
 */
public class EpaTasasParo  implements java.io.Serializable {
    ...
    public EpaTasasParo(int year, int provResid, int sexo, int estudGr, int edadGr, double tparo) {
       this.year = year;
