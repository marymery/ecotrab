...
/**
 * EpaTasasOcup generated by hbm2java
 */
public class EpaTasasOcup  implements java.io.Serializable {
    ...
    public EpaTasasOcup(int year, int provResid, int sexo, int estudGr, int edadGr, double tocup) {
       this.year = year;
